...
from character_config import CHARACTER_NAME

LogType = Literal['info', 'error']

def mylog(content, ctx: discord.ApplicationContext=None, log_type: LogType='info', guild: discord.Guild=None, channel: discord.TextChannel | discord.VoiceChannel=None, member: discord.Member=None, **options):
    if log_type == 'error':
    ...
    log_text = f'\033[1;94m{now_str}\033[m {type_text}\t\033[1;32m{CHARACTER_NAME}\033[m {content_}'
    print(log_text)
